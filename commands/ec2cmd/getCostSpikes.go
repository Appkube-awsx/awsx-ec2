...
// cmd used to get Cost Spike of AWS EC2 :

// go run main.go --zone=us-east-1 --accessKey=<h> --secretKey=<> --crossAccountRoleArn=<>  --externalId=<>  --env=<> GetCostSpike --granularity=DAILY --startDate=2023-03-01 --endDate=2023-04-01
